...
public abstract class UITweener : IgnoreTimeScale
{
	...
	public bool UserAnimationCurve = false;
	public UnityEngine.AnimationCurve animationCurveCurve;
	...
	void Update ()
	{
		...
		float val = 0;
		if (!this.UserAnimationCurve) {
			// Calculate the sampling value
			val = Mathf.Clamp01(mFactor);
			...
			val = this.animationCurveCurve.Evaluate (mFactor);
		}
